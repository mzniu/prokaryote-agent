...
- 可以使用的导入：typing, json, re, datetime, pathlib 等标准库
- 如果需要网络搜索，使用: `from prokaryote_agent.skills.web_tools import web_search, search_legal, search_wikipedia`
- 如果需要知识库，使用: `from prokaryote_agent.knowledge import search_knowledge, store_knowledge`
