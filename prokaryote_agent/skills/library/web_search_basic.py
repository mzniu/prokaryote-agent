"""
技能: 网络搜索
描述: 使用搜索引擎获取信息，支持多引擎、关键词优化
领域: general
层级: basic
生成时间: 2026-02-07T16:08:41.289557
...
class WebSearchBasic(Skill):
    """
    网络搜索

    使用搜索引擎获取信息，支持多引擎、关键词优化
    """

    def __init__(self, metadata: SkillMetadata = None):
        if metadata is None:
            metadata = SkillMetadata(
                skill_id="web_search_basic",
                name="网络搜索",
                tier="basic",
                domain="general",
                description="使用搜索引擎获取信息，支持多引擎、关键词优化"
            )
