...
DIMENSION_PRESETS: Dict[str, List[Dict[str, Any]]] = {
    ...
    "document": [
        {
            "name": "内容完整性",
            "description": "文档是否包含所有必要的实质内容（非占位符）。注意：仅有标题框架和[请填写...]占位符不算完整",
            "weight": 0.35,
            "scoring_guide": "0-2: 只有框架/占位符无实质内容; 3-5: 部分内容已填写; 6-7: 基本完整; 8-10: 非常完整"
        },
        {
            "name": "专业准确性",
            "description": "专业术语、法律引用和内容是否准确无误",
            "weight": 0.25,
            "scoring_guide": "0-3: 多处错误或无专业内容; 4-6: 部分准确; 7-8: 基本准确; 9-10: 完全准确"
        },
        {
            "name": "表达清晰度",
            "description": "文档的实质内容表达是否清晰、易于理解",
            "weight": 0.2,
            "scoring_guide": "0-3: 难以理解或无实质表达; 4-6: 勉强可读; 7-8: 表达清晰; 9-10: 表达优秀"
        },
        {
            "name": "格式规范性",
