"""
快速重建prokaryote_agent模块的脚本
"""
import os
from pathlib import Path

# 模块代码模板
GENERATION_MANAGER_CODE = '''"""GenerationManager - 代际管理器"""
import json
import shutil
from pathlib import Path
...
# 创建GenerationManager
write_file("prokaryote_agent/daemon/generation_manager.py", GENERATION_MANAGER_CODE)
